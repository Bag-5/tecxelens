      ...
      <div className="relative w-full max-w-2xl">
        ...
        {loading ? (
          ...
          <>
            ...
            {selectedFile && (
              <div className="mt-5 sm:mt-6 space-y-4 animate-fade-slide-up">
        ...
        {error && (
          <div className="mt-5 sm:mt-6 rounded-lg border border-red-500/20 dark:border-red-500/20 bg-red-50 dark:bg-red-500/10 px-4 py-3 text-sm text-red-600 dark:text-red-300">{error}</div>
        )}
      </div>
    </div>
  );
