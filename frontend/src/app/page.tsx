...
export default function Home() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4 sm:px-6 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-indigo-400/20 dark:bg-indigo-500/10 blur-[100px] sm:blur-[120px] animate-pulse-glow" />
      <div className="absolute bottom-1/4 right-1/4 w-56 sm:w-80 h-56 sm:h-80 rounded-full bg-cyan-400/20 dark:bg-cyan-500/10 blur-[80px] sm:blur-[100px] animate-pulse-glow" style={{ animationDelay: "1s" }} />

      <div className="relative text-center max-w-xl">
        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 dark:border-indigo-500/20 bg-indigo-100 dark:bg-indigo-500/5 px-4 py-1.5 text-[11px] sm:text-xs text-indigo-700 dark:text-indigo-300 mb-5 sm:mb-6">
